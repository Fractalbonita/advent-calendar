<template>
  <div>
    <section v-if="!christmasEve" class="beers__timer">
      <h2 class="beers__timer_headline">
        Christmas is coming soon! <br />
        The list of award-winning beers will be available on the 24th of
        December.
      </h2>
      <img
        src="../assets/images/Logo.png"
        alt="Logo"
        class="beers__timer_logo"
      />
    </section>
    <section v-else>
      ...
      <section v-else>
        ...
        <div v-else class="beers">
          ...
          <BaseFilterButton
            v-bind:options="awards"
            v-on:change="handleAwards"
          />
